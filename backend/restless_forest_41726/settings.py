"""
Django settings for restless_forest_41726 project.
...
ROOT_URLCONF = 'restless_forest_41726.urls'
...
WSGI_APPLICATION = 'restless_forest_41726.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_forest_41726 API",
    "DESCRIPTION": "API documentation for restless_forest_41726 App",
    "VERSION": "v1",
}
